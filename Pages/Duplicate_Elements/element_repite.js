...
class footer_duplicate extends HTMLElement {
    connectedCallback(){
        ...
        <div>
            <a href="facebook.com"><img src="../../Imgs/social_networks/Facebook_logo-1048x1048.png" alt=""></a>
            <a href="twitter.com"><img src="../../Imgs/social_networks/Twitter_logo-1048x1048.png" alt=""></a>
            <a href="instagram.com"><img src="../../Imgs/social_networks/Instagram_logo-1048x1048.png" alt=""></a>
        </div>
        
        <div>
        <p>Todos los derechos resevados Alvaro Amestoy</p>
        </div>
    </footer>`;
    }
}
